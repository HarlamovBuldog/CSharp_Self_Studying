...
namespace Cash_desk
{
    public class MainWindowViewModel : NotifyUIBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new ViewVM{ ViewDisplay="Groups", ViewType = typeof(GroupView), ViewModelType = typeof(GroupViewModel)},
                new ViewVM{ ViewDisplay="Childs", ViewType = typeof(ChildView), ViewModelType = typeof(ChildViewModel)}
            };
            Views = views;
